...
const sc = StyleSheet.create({
  ...
  previewImg: { backgroundColor: Colors.bgCard, borderRadius: Radius.xl, minHeight: 240, alignItems: 'center', justifyContent: 'center', gap: Space.s8, marginBottom: Space.s24, overflow: 'hidden', ...Shadow.sm },
  previewImageContainer: { position: 'relative', width: '100%', height: 240 },
  previewImage: { width: '100%', height: 240 },
  heatmapOverlay: { position: 'absolute', top: 0, left: 0, width: '100%', height: 240, opacity: 0.6 },
